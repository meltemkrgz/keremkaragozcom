...
import {
  ...
  Instagram,
  Linkedin,
  ChevronsUp, // Added ChevronsUp for scroll to top
} from "lucide-react";
import "./Anasayfa.css";
...
const StatsCounter = ({
  ...
  return (
    ...
    >
      {IconComponent && (
        <IconComponent className="stat-icon" size={48} strokeWidth={1.5} />
      )}
...
const Anasayfa = () => {
  ...
  const handleScroll = useCallback(() => {
    ...
    for (const [sectionName, refElement] of sectionsArray) {
      if (
        refElement &&
        refElement.offsetTop <= pageYOffset + navbarHeight + 50
      ) {
      ...
      <div className="preloader">
        <div className="preloader-content">
          <svg viewBox="0 0 100 100" className="preloader-svg-icon">
            <path
              d="M50,15 C20,15 20,50 50,50 C80,50 80,15 50,15 M50,50 C20,50 20,85 50,85 C80,85 80,50 50,50"
              stroke="currentColor"
              strokeWidth="5"
              fill="none"
              strokeLinecap="round"
  ...
  return (
    <div className="homepage">
          ...
          <div className="hero-text">
            <AnimatedSection>
              <h1 className="hero-title">
                ...
                <span className="highlight">
                  İçsel Potansiyelinizi Keşfedin
                </span>
              </h1>
            </AnimatedSection>
            <AnimatedSection delayClass="delay-1">
              <p className="hero-description">
                ...
                Daha dengeli, huzurlu ve anlamlı bir yaşam için size destek
                oluyorum. Her bireyin ihtiyacı farklıdır; bu nedenle size en
                uygun yöntemlerle, güvenli ve destekleyici bir süreç sunuyorum.
                Kendinize bir adım atmak isterseniz, tanışmaktan memnuniyet
                duyarım.
              </p>
            </AnimatedSection>
            <AnimatedSection delayClass="delay-2">
              <div className="hero-actions">
                <a
                  href="#hizmetlerim"
                  className="cta-primary btn btn-primary"
                ...
                <a
                  href="/Iletisim"
                  className="cta-secondary btn btn-secondary"
                  onClick={(e) => scrollToSection(e, "iletisim")}
                >
                  İletişime Geç
                  <Phone size={20} />
        ...
        <div className="container">
          <AnimatedSection className="section-header">
            ...
            <p className="subtitle">
              Size özel, bilimsel temelli ve empatik bir destek.
            </p>
          </AnimatedSection>
          <AnimatedSection>
            <div className="features-grid">
              {[
                {
                  icon: GitFork,
                  title: "Eklektik & Bütüncül Yaklaşım",
                  desc: "Düşünce, duygu, davranış ve bedensel (somatik) deneyimlerinizi bir bütün olarak ele alarak, size en uygun terapi yöntemlerini birleştiriyorum.",
                },
                {
                  icon: Shield,
                  title: "Gizlilik & Güven Esaslı",
                  desc: "Tüm görüşmelerimiz etik ilkeler çerçevesinde, %100 gizlilik ve karşılıklı güven ilişkisi üzerine kuruludur.",
                },
                {
                  icon: UserCheck,
                  title: "Uzmanlık & Sürekli Gelişim",
                  desc: "EMDR, Aile Danışmanlığı, Attentioner gibi alanlarda uzmanlık eğitimlerimi tamamladım ve en güncel yaklaşımları takip ediyorum.",
                },
              ].map((feature, index) => (
                <div
      ...
      <section
        id="istatistikler"
        ref={setSectionRef("istatistikler")}
      ...
      >
        <div className="container">
          <AnimatedSection className="section-header">
            ...
            <p className="subtitle">
              Rakamlarla mesleki yolculuğum ve danışanlarıma katkılarım.
            </p>
          </AnimatedSection>
          <div className="stats-grid">
            <StatsCounter
              ...
              duration={2500}
              label="Gerçekleşen Danışma Seansı (Nisan 2025 itibarıyla)"
              icon={TrendingUp}
              suffix="+"
              className="delay-0"
            />
            <StatsCounter
              end={new Date().getFullYear() - 2019}
              duration={2000}
              label="Yıllık Mesleki Deneyim"
              icon={Award}
              suffix="+"
              className="delay-1"
            />
            <StatsCounter
              ...
              duration={2000}
              label="Tamamlanmış Uzmanlık Eğitimi"
              icon={BookMarked}
              suffix="+"
              className="delay-2"
            />
            <StatsCounter
              ...
              duration={3000}
              label="Danışan Odaklı Memnuniyet Hedefi (%)"
              icon={SmilePlus}
              suffix="%"
              className="delay-3"
            />
      ...
      >
        <div className="container">
          <AnimatedSection className="section-header">
            ...
            <p className="subtitle">
              İhtiyaçlarınıza yönelik profesyonel psikolojik destek.
            </p>
          </AnimatedSection>
          <AnimatedSection>
              ...
              {[
                {
                  ...
                  desc: "Kaygı, depresyon, stres, travma, fobi, yas, özgüven sorunları ve kişisel gelişim hedefleriniz için birebir destek.",
                ...
                },
                {
                  id: "emdr-terapisi",
                  title: "EMDR Terapisi",
                  desc: "Travmatik yaşantıların (TSSB), fobilerin, kaygı bozukluklarının ve olumsuz yaşam deneyimlerinin etkilerini azaltmaya yönelik bilimsel bir yöntem.",
                  icon: <Eye size={32} />,
                  image:
                    "https://www.psikoaktif.com/wp-content/uploads/2018/03/emdr-definition.jpg",
                },
                {
                  id: "aile-cift-terapisi",
                  title: "Aile ve Çift Danışmanlığı",
                  desc: "İlişkilerdeki iletişim sorunları, çatışmalar, uyum problemleri ve boşanma süreçleri gibi konularda destek.",
                  icon: <Users2 size={32} />,
                  image:
                      ...
                      onClick={(e) => {
                        ...
                        if (contactFormSubject)
                          contactFormSubject.value =
                            service.title + " Hakkında Bilgi/Randevu";
      ...
      <section className="testimonials">
        <div className="container">
          <AnimatedSection className="section-header">
            ...
            <p className="subtitle">
              Paylaşılan geri bildirimler (Google yorumlar).
            </p>
          </AnimatedSection>
          <AnimatedSection>
            <div className="testimonials-grid">
              {[
                {
                  name: "O. H.",
                  text: "Kendinizi ve duygularınızı önemseyin çünkü herkesin daha iyi hissetmeye hakkı vardır. Kerem Hocam her şey için çok teşekkür ederim",
                  avatar:
                    "https://lh3.googleusercontent.com/a-/ALV-UjUjakVIqbQ5cdbzR37W_266J_lmuL6_ZqYNQxeNmsb51OmhC6nP=w108-h108-p-rp-mo-br100",
                },
                {
                  name: "M. U.",
                  text: "En önemli özelliği empati yeteneği herkes kendini kolay kolay başkasının yerine koyamaz olaylara farklı bakış açısıyla insanın ufkunu genişletiyor yollarımız kesiştiği için çok mutluyum teşekkürler yolun açık olsun",
                  avatar:
                    "https://lh3.googleusercontent.com/a/ACg8ocLJa_pe8YZgq4CMCzeU429LNhb4Pkg_6kN0C_YlJTYdgcb15A=w108-h108-p-rp-mo-br100",
                },
                {
                  name: "H. E.",
                  text: "Genç yaşında bu kadar donanımlı Mesleğiyle içli dışlı olan bir Danışman kesinlikle tavsiye edin ettirin",
                  avatar:
                    "https://lh3.googleusercontent.com/a/ACg8ocIAx9pCKzcSVlurTNcHd-anuNgMT3Y9CmR0Ri-9ee9TjDm4oA=w108-h108-p-rp-mo-br100",
                },
      ...
      >
        <div className="container">
          <AnimatedSection className="section-header">
            ...
            <p className="subtitle">
              Randevu almak, soru sormak veya bilgi almak için formu doldurunuz.
            </p>
          </AnimatedSection>
          <AnimatedSection>
            <div className="contact-content">
              <div className="contact-info animate-slideInLeft">
                ...
                <p>
                  {clinicName} <br /> Psikolojik Danışman {counselorName}
                </p>
                <div className="contact-details">
                  ...
                  <a
                    href="mailto:danismapsikolojisi@gmail.com"
                  ...
                  <a
                    href="https://www.google.com/maps/search/?api=1&query=Kemaliye+Mh.+Cumhuriyet+Meydanı.+No:7+Kat:1,+1+No'lu+İşyeri+Hendek+Sakarya"
                    target="_blank"
              ...
              <div className="contact-form-wrapper animate-slideInRight delay-1">
                ...
                <form
                  ...
                  onSubmit={(e) => {
                    e.preventDefault();
                    alert(
                      "Mesajınız tarafıma ulaştı. En kısa sürede sizinle iletişime geçeceğim."
                    );
                    e.target.reset();
                  }}
                >
                  ...
                  <div className="form-group">
                    <label htmlFor="phone_contact">Telefon Numaranız (Opsiyonel)</label>
                    <input
                      id="phone_contact"
                      name="phone_contact"
                      type="tel"
                  ...
                  <div className="form-group">
                    ...
                    >
                      <option value="">
                        İlgilendiğiniz Hizmeti Seçiniz...
                      </option>
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      id="message"
                      name="message"
                      placeholder="Kısaca mesajınızı veya sorunuzu buraya yazabilirsiniz..."
                      rows={5}
                      required
                      aria-required="true"
                    ></textarea>
